      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3">
            <Link
              href="/upload"
              className="px-5 py-2.5 bg-primary text-primary-foreground rounded-lg font-semibold hover:opacity-90 transition-opacity"
            >
              + New Video
            </Link>
            <Link
              href="/settings"
              className="px-5 py-2.5 glass rounded-lg font-semibold hover:bg-white/10 transition-colors"
            >
              Settings
            </Link>
          </div>
